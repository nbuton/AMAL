...
def process(mode: str, ds: Dataset, map: dict,tokenizer):
    """Process the dataset
    """
...
def cli(vocab_size: int):
    ...
    CLASSMAP = { 0: 0, 4: 1 }
    generatedata("test", tokenizer, vocab_size, ds, CLASSMAP)
    generatedata("train", tokenizer, vocab_size, ds, CLASSMAP)
